			            ...
			            <div class="card-body p-2 p-md-3">
			                ...
			                <div id="divRecords" class="m-0 p-0 mt-2">
								<div class="table-responsive">
									<table class="table table-centered d">
										<thead>
											<tr>
												<th class="">Name </th>
												<th>Contatct num</th>
										...
										<tbody id="tblBody">
											<c:forEach  items="${appointmentDetails_lists}" var="appointmentDetails_lists">
												...
												<tr id="row_${appointmentDetails_lists.appointment_id}">
													...
													<td>
								                    <a href="javascript:void(0);" onclick="ConfirmBtnBooking('${appointmentDetails_lists.appointment_id}')" data-toggle="tooltip" title="" class="table-icon text-primary">Confirm</a>
								                   	<a href="javascript:void(0);" onclick="ConfirmBtnReject('${appointmentDetails_lists.appointment_id}')" class="table-icon text-danger"> Cancel Appointment</a>
         ...
         <div class="modal fade" id="ConfirmReject" role="dialog" aria-hidden="true">
			    <div class="modal-dialog modal-dialog-centered">
			        <div class="modal-content">
			            <div class="modal-header">
			                <h4 class="modal-title" id="bottomModalLabel">Cancel Appointment</h4>
			            ...
			            <div class="modal-footer">
			                ...
			                <button type="button" class="btn btn-primary"  id="bDelete" onclick="RejectRecord()">Cancel Appointment</button>
		  ...
		  <div class="modal fade" id="ConfirmBooking" role="dialog" aria-hidden="true">
			    <div class="modal-dialog modal-dialog-centered">
			        <div class="modal-content">
			            <div class="modal-header">
			                <h4 class="modal-title" id="bottomModalLabel">Mark Confirm Appointment</h4>
			                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
			            </div>
			            <div class="modal-body">
