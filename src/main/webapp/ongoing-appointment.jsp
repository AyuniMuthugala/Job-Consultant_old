										...
										<tbody id="tblBody">
											<c:forEach  items="${appointmentDetails_lists}" var="appointmentDetails_lists">
												...
												<tr id="row_${appointmentDetails_lists.appointment_id}">
													...
													<td>
								                    <a href="javascript:void(0);" onclick="ConfirmBtnBooking('${appointmentDetails_lists.appointment_id}')" data-toggle="tooltip" title="" class="table-icon text-primary">Finish Appointment</a>
			    ...
			    <div class="modal-dialog modal-dialog-centered">
			        <div class="modal-content">
			            <div class="modal-header">
			                <h4 class="modal-title" id="bottomModalLabel">Complete  Appointment</h4>
			                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
			            </div>
			            <div class="modal-body">
			                <p>Are you sure you want to Complete  this Appontment of Customer?</p>
