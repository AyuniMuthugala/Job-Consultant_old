...
import com.assignment.services.Appointments_Services;
import com.assignment.services.CommonServices;
 
import com.assignment.services.Country_Service;
import com.assignment.services.JobType_Service;
import com.assignment.services.Job_Seekers_Services;
...
public class AppointmentControllerServlet extends HttpServlet {
	...
	private void addInfo(HttpServletRequest request, HttpServletResponse response)throws ServletException, IOException {
		...
		String tableappointmentsName ="tbl_appointments";
		String tablejob_seekersName ="tbl_seekers";
