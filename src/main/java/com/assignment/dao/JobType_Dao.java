...
public class JobType_Dao {
	...
	public static List<JobType> GetAll(DataSource datasource){
		...
		try {
			...
			sql ="select job_type_specialization_id,job_type_name from tbl_job_type";
	...
	public static JobType Get(DataSource datasource, String job_type_id) {
	    ...
	    try {
	        con = datasource.getConnection();
	        sql = "select job_type_specialization_id,job_type_name from tbl_job_type where job_type_specialization_id =?";
